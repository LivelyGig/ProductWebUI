            ...
            <.div(^.className:="col-md-4 col-md-offset-4 col-sm-offset-3 col-xs-offset-4",CreateAgentCSS.Style.modalContainer)(
                ...
                <.div(^.className:="col-md-12 col-sm-12 col-xs-12")(
                  ...
                  <.div(CreateAgentCSS.Style.marginTopClosebtn , ^.className:="row")(
                    ...
                    <.div(^.className:="col-md-8 col-sm-8 col-xs-8")(
                      <.input(^.className:="form-control", CreateAgentCSS.Style.inputHeightWidth,^.`type`:="email",
                        ^.required:=true,^.onChange==>B.updateEmail)
                    )
                  ),
                  ...
                  <.div(^.className:="row")(
                    ...
                    <.div(^.className:="col-md-8 col-sm-8 col-xs-8")(
                      <.input(^.className:="form-control", CreateAgentCSS.Style.inputHeightWidth,
                        ^.`type`:="password",^.required:=true,^.onChange==>B.updatePassword)
                    )
                  )
                )
              ),
              <.div(CreateAgentCSS.Style.ModalFoot , ^.className:="row")(
                ...
                <.div(^.className:="col-md-2 col-sm-2 col-xs-2 col-md-offset-4 col-sm-offset-4 col-xs-offset-4 ")(
                  <.button(CreateAgentCSS.Style.marginLeftCloseBtn, ^.className:="btn btn-default", ^.tpe := "submit"
                  )("Login")
                ),
                <.div(^.className:="col-md-3 col-sm-3 col-xs-3")(
