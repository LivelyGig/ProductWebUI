...
//
//  case class State(showaddEndUserAgreementFlag: Boolean = false
//                  )
//
...
//      t.modState(s => s.copy(showaddEndUserAgreementFlag = true))
//    }
//    def addEndUserAgreement() : Callback = {
//      t.modState(s => s.copy(showaddEndUserAgreementFlag = true))
//    }
...
//    }
//
//    def addEndUserAgreement(userModel: UserModel, showaddEndUserAgreementFlag: Boolean = false): Callback = {
//      log.debug(s"addNewAgent userModel : ${userModel} ,addNewAgent: ${showaddEndUserAgreementFlag}")
//      if(showaddEndUserAgreementFlag){
//        createUser(userModel).onComplete {
//          case Success(s) =>
//            log.debug(s"createUser msg : ${s.msgType}")
//            if (s.msgType == ApiResponseMsg.CreateUserWaiting){
//              t.modState(s => s.copy(showaddEndUserAgreementFlag = true)).runNow()
//            } else {
...
//        t.modState(s => s.copy(showaddEndUserAgreementFlag = true))
//      } else {
//        t.modState(s => s.copy(showaddEndUserAgreementFlag = false))
//      }
//    }
//  }
//
//  val component = ReactComponentB[Props]("EndUserAgreement")
//    .initialState(State())
//    .backend(new Backend(_))
//    .renderPS(($, P, S) => {
//      val B = $.backend
//      <.div(ProjectCSS.Style.displayInitialbtn)(
//        Button(Button.Props(B.addEndUserAgreement(), CommonStyle.default, Seq(HeaderCSS.Style.createNewProjectBtn)),"End User Agreement"),
//        if (S.showaddEndUserAgreementFlag) EndUserAgreementForm(EndUserAgreementForm.Props(B.addEndUserAgreement))
//        else
