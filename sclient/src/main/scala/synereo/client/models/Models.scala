package synereo.client.models

import shared.dtos.{Connection, EvalSubscribeResponseContent}
...
//case class UserModel(email: String = "", password: String = "", name: String = "", lastName: String = "", createBTCWallet: Boolean = true,
