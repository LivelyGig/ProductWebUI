    ...
    .renderPS((t, props, state) => {
      ...
      Modal(
        ...
        <.div(bss.modal.footer, LoginCSS.Style.loginModalFooter)(
          Button(Button.Props(t.backend.addNewUserForm(), CommonStyle.default, Seq(LoginCSS.Style.dontHaveAccountBtnLoginModal), "", ""), state.lang.selectDynamic("DON'T HAVE AN ACCOUNT?").toString),
